...
* The following dependency is not known to work with Spring Native: 'Zipkin Client'. As a result, your application may not work as expected.
* The original package name 'com.nullchefo.native' is invalid and this project uses 'com.example.demo' instead.
